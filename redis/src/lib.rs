...
//!
//! The library facilitates this by providing the [crate::commands::TypedCommands] and [crate::commands::AsyncTypedCommands]
//! as alternatives to [crate::commands::Commands] and [crate::commands::AsyncCommands] respectively. These traits provide functions
