use super::{RedisFuture, SharedHandleContainer};
use crate::{
...
impl ConnectionManagerConfig {
    ...
    ///
    /// Will fail client creation if the connection isn't configured for RESP3 communications.
...
impl ConnectionManager {
    ...
    pub async fn new_with_config(
        ...
        if let Some(push_sender) = config.push_sender.clone() {
            ...
            connection_config = connection_config.set_push_sender(internal_sender);
        }
