...
# if you use smol
redis = { version = "0.32.6", features = ["smol-comp"] }
```
...
```
redis = { version = "0.32.6", features = ["tls-native-tls"] }

# if you use tokio
redis = { version = "0.32.6", features = ["tokio-native-tls-comp"] }

# if you use smol
redis = { version = "0.32.6", features = ["smol-native-tls-comp"] }
```

To use `rustls`:

```
redis = { version = "0.32.6", features = ["tls-rustls"] }

# if you use tokio
redis = { version = "0.32.6", features = ["tokio-rustls-comp"] }

# if you use smol
redis = { version = "0.32.6", features = ["smol-rustls-comp"] }
```
...
`redis = { version = "0.32.6", features = [ "cluster"] }`
...
`redis = { version = "0.32.6", features = [ "cluster-async", "tokio-std-comp" ] }`
...
`redis = { version = "0.32.6", features = ["json"] }`
