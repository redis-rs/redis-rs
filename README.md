...
```
# if you use tokio
redis = { version = "1.0.0-alpha", features = ["tokio-comp"] }

# if you use smol
redis = { version = "1.0.0-alpha", features = ["smol-comp"] }
...
```
redis = { version = "1.0.0-alpha", features = ["r2d2"] }
```
...
```
redis = { version = "1.0.0-alpha", features = ["tls-native-tls"] }

# if you use tokio
redis = { version = "1.0.0-alpha", features = ["tokio-native-tls-comp"] }

# if you use smol
redis = { version = "1.0.0-alpha", features = ["smol-native-tls-comp"] }
...
```
redis = { version = "1.0.0-alpha", features = ["tls-rustls"] }

# if you use tokio
redis = { version = "1.0.0-alpha", features = ["tokio-rustls-comp"] }

# if you use smol
redis = { version = "1.0.0-alpha", features = ["smol-rustls-comp"] }
...
`redis = { version = "1.0.0-alpha", features = [ "cluster"] }`
...
`redis = { version = "1.0.0-alpha", features = [ "cluster-async", "tokio-std-comp" ] }`
...
`redis = { version = "1.0.0-alpha", features = ["json"] }`
