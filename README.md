...
# if you use smol
redis = { version = "0.32.3", features = ["smol-comp"] }

# if you use async-std
redis = { version = "0.32.3", features = ["async-std-comp"] }
```
...
```
redis = { version = "0.32.3", features = ["r2d2"] }
```
...
```
redis = { version = "0.32.3", features = ["tls-native-tls"] }

# if you use tokio
redis = { version = "0.32.3", features = ["tokio-native-tls-comp"] }

# if you use smol
redis = { version = "0.32.3", features = ["smol-native-tls-comp"] }

# if you use async-std
redis = { version = "0.32.3", features = ["async-std-native-tls-comp"] }
```

To use `rustls`:

```
redis = { version = "0.32.3", features = ["tls-rustls"] }

# if you use tokio
redis = { version = "0.32.3", features = ["tokio-rustls-comp"] }

# if you use smol
redis = { version = "0.32.3", features = ["smol-rustls-comp"] }

# if you use async-std
redis = { version = "0.32.3", features = ["async-std-rustls-comp"] }
```
...
`redis = { version = "0.32.3", features = [ "cluster"] }`
...
`redis = { version = "0.32.3", features = [ "cluster-async", "tokio-std-comp" ] }`
...
`redis = { version = "0.32.3", features = ["json"] }`
