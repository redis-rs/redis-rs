...
redis = { version = "0.29.0", features = ["async-std-comp"] }
```
...
# if you use async-std
redis = { version = "0.29.0", features = ["async-std-native-tls-comp"] }
```

To use `rustls`:

```
redis = { version = "0.29.0", features = ["tls-rustls"] }

# if you use tokio
redis = { version = "0.29.0", features = ["tokio-rustls-comp"] }

# if you use async-std
redis = { version = "0.29.0", features = ["async-std-rustls-comp"] }
```
...
`redis = { version = "0.29.0", features = [ "cluster"] }`
...
`redis = { version = "0.29.0", features = [ "cluster-async", "tokio-std-comp" ] }`
