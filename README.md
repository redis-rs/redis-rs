...
```
# if you use tokio
redis = { version = "1.0.0-rc.0", features = ["tokio-comp"] }

# if you use smol
redis = { version = "1.0.0-rc.0", features = ["smol-comp"] }
```
...
```
redis = { version = "1.0.0-rc.0", features = ["r2d2"] }
```
...
```
redis = { version = "1.0.0-rc.0", features = ["tls-native-tls"] }

# if you use tokio
redis = { version = "1.0.0-rc.0", features = ["tokio-native-tls-comp"] }

# if you use smol
redis = { version = "1.0.0-rc.0", features = ["smol-native-tls-comp"] }
```

To use `rustls`:

```
redis = { version = "1.0.0-rc.0", features = ["tls-rustls"] }

# if you use tokio
redis = { version = "1.0.0-rc.0", features = ["tokio-rustls-comp"] }

# if you use smol
redis = { version = "1.0.0-rc.0", features = ["smol-rustls-comp"] }
```
...
`redis = { version = "1.0.0-rc.0", features = [ "cluster"] }`
...
`redis = { version = "1.0.0-rc.0", features = [ "cluster-async", "tokio-std-comp" ] }`
...
`redis = { version = "1.0.0-rc.0", features = ["json"] }`
