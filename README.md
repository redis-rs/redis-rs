...
redis = { version = "0.27.4", features = ["async-std-comp"] }
```
...
```
redis = { version = "0.27.4", features = ["tls-native-tls"] }

# if you use tokio
redis = { version = "0.27.4", features = ["tokio-native-tls-comp"] }

# if you use async-std
redis = { version = "0.27.4", features = ["async-std-native-tls-comp"] }
```

To use `rustls`:

```
redis = { version = "0.27.4", features = ["tls-rustls"] }

# if you use tokio
redis = { version = "0.27.4", features = ["tokio-rustls-comp"] }

# if you use async-std
redis = { version = "0.27.4", features = ["async-std-rustls-comp"] }
```
...
`redis = { version = "0.27.4", features = [ "cluster"] }`
...
`redis = { version = "0.27.4", features = [ "cluster-async", "tokio-std-comp" ] }`
...
`redis = { version = "0.27.4", features = ["json"] }`
