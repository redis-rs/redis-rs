...
#[allow(dead_code)] // Used by the cluster matrix macros added in a subsequent commit.
...
#[allow(dead_code)] // Used by the cluster and sentinel matrix macros added in subsequent commits.
